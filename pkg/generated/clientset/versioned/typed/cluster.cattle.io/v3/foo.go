...
type FooInterface interface {
	Create(ctx context.Context, foo *v3.Foo, opts v1.CreateOptions) (*v3.Foo, error)
	Update(ctx context.Context, foo *v3.Foo, opts v1.UpdateOptions) (*v3.Foo, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v3.Foo, error)
	List(ctx context.Context, opts v1.ListOptions) (*v3.FooList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v3.Foo, err error)
	FooExpansion
}
...
func newFoos(c *ClusterV3Client, namespace string) *foos {
	return &foos{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *foos) Get(ctx context.Context, name string, options v1.GetOptions) (result *v3.Foo, err error) {
	result = &v3.Foo{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("foos").
...
func (c *foos) List(ctx context.Context, opts v1.ListOptions) (result *v3.FooList, err error) {
...
func (c *foos) Create(ctx context.Context, foo *v3.Foo, opts v1.CreateOptions) (result *v3.Foo, err error) {
	result = &v3.Foo{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("foos").
...
func (c *foos) Update(ctx context.Context, foo *v3.Foo, opts v1.UpdateOptions) (result *v3.Foo, err error) {
	result = &v3.Foo{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("foos").
...
func (c *foos) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v3.Foo, err error) {
	result = &v3.Foo{}
